...
The [Hospitality Sample VA]({{site.baseurl}}/virtual-assistant/samples/hospitality-assistant) demonstrates this skill and a number of other skills to demonstrate a more in-depth hospitality experience.
